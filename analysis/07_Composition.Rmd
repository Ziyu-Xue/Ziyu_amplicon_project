...
# Narrow in on a specific group
# Bacillota - y: abundance, x: collection site, dot plot + boxplot
...
# Bacillota - y: abundance, x: collection day, dot plot + boxplot
...
# Narrow in on a specific group
# Bacteroidota - y: abundance, x: collection site, dot plot + boxplot
...
# Bacteroidota - y: abundance, x: collection day, dot plot + boxplot
...
# Narrow in on a specific group
# Pseudomonadota - y: abundance, x: collection site, dot plot + boxplot
...
# Pseudomonadota - y: abundance, x: collection day, dot plot + boxplot
