...
```{r station-diversity-simpson-burn, fig.height=4, fig.width=4}
...
```{r station-diversity-simpson-spared, fig.height=4, fig.width=4}
spared_obs_simp_df<-
  obs_simps_df%>%
...
```{r station-diversity-richness-burn, fig.height=4, fig.width=4}
...
```{r station-diversity-richness-spared, fig.height=4, fig.width=4}
