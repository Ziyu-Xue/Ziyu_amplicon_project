...
# Sorensen Betadisper - collection day
dispr_sorensen_day <- betadisper(scaled_sorensen_dist, metadata_df$`collection.day.post.admission`)
...
permutest(dispr_sorensen_day)

# Sorensen Betadisper - site  
dispr_sorensen_site <- betadisper(scaled_sorensen_dist, metadata_df$`env_local_scale`)
permutest(dispr_sorensen_site)
